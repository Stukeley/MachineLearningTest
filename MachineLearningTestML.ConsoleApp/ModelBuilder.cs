...
namespace MachineLearningTestML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"E:\Programowanie\Stukeley\MachineLearningTest\MachineLearningTest\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"F:\Temp\MLVSTools\MachineLearningTestML\MachineLearningTestML.Model\MLModel.zip";
